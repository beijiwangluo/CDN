...
$.fn.Sonline.defualts={Position:"left",Top:200,Effect:true,Width:170,DefaultsOpen:true,Style:1,Tel:"",Title:"在线客服",FooterText:'',Website:'',Qqlist:""}
...
{case 1:typeNum=41;break
case 2:typeNum=42;break
case 3:typeNum=44;break
case 4:typeNum=45;break
case 5:typeNum=46;break
case 6:typeNum=47;break
default:typeNum=41;}
return typeNum;}
...
for(var i=0;i<strs.length;i++){var subStrs=new Array();var subQqlist=strs[i];subStrs=subQqlist.split("|");var type=parseInt(subStrs[2]);QqHtml+="<div class='QQList'><span>"+subStrs[1]+"：</span><div class='ico'>";switch(type){case 2:QqHtml+="<a target='_blank' href='http://amos1.taobao.com/msg.ww?v=2&uid="+subStrs[0]+"&s=1' >";QqHtml+="<img border='0' src='http://amos1.taobao.com/online.ww?v=2&uid="+subStrs[0]+"&s=1' alt='"+alt+"' title='"+alt+"' />";QqHtml+="</a>";break;case 3:QqHtml+="<a target='_blank' href='http://amos.im.alisoft.com/msg.aw?v=2&amp;uid="+subStrs[0]+"&amp;site=cnalichn&amp;s=4'>";QqHtml+="<img alt='"+alt+"' title='"+alt+"' border='0' src='http://amos.im.alisoft.com/online.aw?v=2&amp;uid="+subStrs[0]+"&amp;site=cnalichn&amp;s=4' />";QqHtml+="</a>";break;case 6:QqHtml+="<a target='_blank' href='http://amos.alicdn.com/msg.aw?v=2&amp;uid="+subStrs[0]+"&amp;site=enaliint&amp;s=24&amp;charset=UTF-8' ";QqHtml+="  style='text-align:center;' data-uid='"+subStrs[0]+"'>";QqHtml+="<img style='border:none;vertical-align:middle;margin-right:5px;' ";QqHtml+=" src='http://amos.alicdn.com/online.aw?v=2&amp;uid="+subStrs[0]+"&amp;site=enaliint&amp;s=22&amp;charset=UTF-8'>";QqHtml+=""+subStrs[0]+"</a>";break;case 4:QqHtml+="<a target=blank href='msnim:chat?contact="+subStrs[0]+"&Site="+subStrs[0]+"'>";QqHtml+="<img src='"+msn+"' alt='"+alt+"' title='"+alt+"'/>";QqHtml+="</a>";break;case 5:var skype=opts.Website+"/Public/Images/online/skype.gif";QqHtml+="<a target=blank href='callto://"+subStrs[0]+"'>";QqHtml+="<img border='0' src='"+skype+"' alt='"+alt+"' title='"+alt+"'/>";QqHtml+="</a>";break;case 7:QqHtml+=subStrs[0];break;case 1:default:QqHtml+="<a target='_blank' href='http://wpa.qq.com/msgrd?v=3&uin="+subStrs[0]+"&site=qq&menu=yes'>";QqHtml+="<img border='0' src='http://wpa.qq.com/pa?p=2:"+subStrs[0]+":"+$.fn.Sonline.styleType(opts)+" &amp;r=0.22914223582483828' alt='"+alt+"'  title='"+alt+"'>";QqHtml+="</a>";}
